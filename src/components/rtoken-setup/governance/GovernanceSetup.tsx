  ...
  return (
    <Card p={4} variant="cards.form" {...props}>
      <Box variant="layout.verticalAlign">
        ...
        <DocsLink link="https://finkfi.netlify.app/protocol/reserve_rights_rsr/#reserve-rights-governance" />
      </Box>
      ...
      <Flex variant="layout.verticalAlign" mb={4}>
        ...
        <DocsLink link="https://finkfi.netlify.app/protocol/system_states_roles/" />
      </Flex>
      {!defaultGovernance ? (
        <FormField
      ...
      <Flex mb={4} sx={{ alignItems: 'center' }}>
        ...
        <DocsLink link="https://finkfi.netlify.app/protocol/reserve_rights_rsr/#venice-governor-alexios" />
      </Flex>
