...
import LendingProductDetail from './views/lending/detail'
import RwaPage from './views/rwa/RwaPage'
...
const AppRoutes = () => (
  <Routes>
    ...
    <Route path={ROUTES.LENDING} element={<Lending />} />
    <Route path={`${ROUTES.LENDING}/:type/:id`} element={<LendingProductDetail />} />
