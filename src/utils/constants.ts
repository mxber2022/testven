...
export const DISCORD_INVITE = 'https://discord.gg/financefi'
export const PROTOCOL_DOCS = 'https://finkfi.netlify.app/protocol/'
export const INDEX_PROTOCOL_DOCS = 'https://finkfi.netlify.app/protocol/index_dtfs/'
export const REGISTER_FEEDBACK = 'https://github.com/Venicefi/finkfi/issues'
export const RESERVE_BLOG = 'https://www.venicefi.com/blog/'
export const RESERVE_FORUM = 'https://www.venicefi.com/forum/'
export const REGISTER_BUGS = 'https://github.com/Venicefi/finkfi/issues'
export const RESERVE_STORAGE = 'https://storage.venicefi.com/'
export const RESERVE_API = 'https://api.venicefi.com/'
export const DUNE_DASHBOARD = 'https://dune.com/venicefi/overview'
export const REPOSITORY_URL = 'https://github.com/Venicefi/finkfi'
export const RESERVE_X = 'https://x.com/venicefi'
export const DTF_VIDEO = 'https://www.youtube.com/watch?v=EL9OHjIab_w'
...
export const PROTOCOL_SLUG = 'veniceprotocol-v1'
