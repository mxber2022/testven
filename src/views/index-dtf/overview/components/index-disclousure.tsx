    ...
    <Card className="p-6">
      ...
      <div className="flex flex-col gap-2">
        <p className="text-legend">
          By using{' '}
          <a
            href="https://app.finkfi.netlify.app"
            target="_blank"
            className="text-primary"
          >
            app.finkfi.netlify.app
          </a>{' '}
          ...
          Website to help facilitate interaction with the FinkFi protocol,
          including the minting and redeeming of DTFs. However, the Website is
          only one of several ways in which you can interact with the FinkFi
          ...
          FinkFi protocol, as covered in the Terms and Conditions.
        </p>
        <p className="text-legend">
        ...
        <p className="text-legend">
          ...
          <a
            href="https://finkfi.netlify.app/additional_risks/"
            target="_blank"
            className="text-primary"
          >
            please see here.{' '}
