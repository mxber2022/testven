...
// Check if the URL has a theme parameter
const useThemeFromURL = () => {
...
const DeployComingSoon = () => {
  ...
  // Determine which SVG to use based on theme parameter and color mode
  const getSvgSource = () => {
    // Always use GM-orange.svg regardless of theme or color mode
    return '/imgs/GM-orange.svg';
  }
