    ...
    >
      <div
        className={cn(
          ...
          validated ? 'text-foreground' : ''
        )}
      >
        <div
          className={cn(
            'rounded-full p-2 border border-foreground',
            (isActive || validated) && 'border-foreground text-foreground'
          )}
        >
        ...
        <div
          className={cn(
            ...
            isActive ? 'text-foreground hidden' : ''
          )}
        >
          {title}
        </div>
      ...
      {DEPLOY_STEPS.map(({ id, icon, title, titleSecondary, content }) => (
        ...
        >
          ...
          <AccordionContent className="flex flex-col animate-fade-in">
            <div className="text-2xl font-bold text-foreground ml-6 mb-2">
              {titleSecondary}
            </div>
            {content}
          </AccordionContent>
