...
const DeployerHeader = () => {
  ...
  return (
    <div className="flex items-center justify-between gap-2 px-6 py-5 text-foreground">
      <div className="flex items-center gap-2 ">
        <div className="rounded-full p-[6px] border border-foreground">
      ...
      >
        ...
        <div className="rounded-full p-1 bg-foreground text-secondary dark:bg-foreground/80">
