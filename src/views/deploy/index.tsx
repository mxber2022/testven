  ...
  return (
    <div
      className={cn(
        ...
        type === 'index'
          ? `bg-[url('https://storage.finkfi.netlify.app/index-dtf-cover-orange.png')]`
          : `bg-[url('https://storage.finkfi.netlify.app/yield-dtf-cover-orange.png')]`
      )}
    >
...
const Deploy = () => {
  const description =
    "FinkFi's RToken Factory Contracts: A platform for creating tokens backed by a diverse array of ERC20 collateral."
    ...
    <div className="container mt-10 mb-4 px-4">
      ...
      <div className="flex flex-wrap gap-4 mt-10">
        <DeployBox
          ...
          infoStyle="primary"
          type="index"
          image="https://storage.finkfi.netlify.app/index-dtf-cover-orange.png"
        />
        <DeployBox
          ...
          infoStyle="black"
          type="yield"
          image="https://storage.finkfi.netlify.app/yield-dtf-cover-orange.png"
        />
      </div>
    </div>
  )
