  ...
  <Box variant="layout.borderBox" p={4} {...props}>
    ...
    <Flex mt={2} mb={3}>
      <SmallButton
        ...
        mr={2}
        onClick={() =>
          window.open('https://github.com/Venicefi/finkfi', '_blank')
        }
      >
        Github/Venicefi
      </SmallButton>
    ...
    <InfoBox
      mb={3}
      title={t`What is Venice Governor Alexios?`}
    ...
    <InfoBox
      title={t`Roles`}
      subtitle="Please read more about the different roles in Alexios and the Venice protocol in the documentation."
    />
  </Box>
)
