...
const Risks = () => {
  const content = useMemo(
    () => [
      {
        title: t`Venice Protocol Smart-Contract Risk`,
        description: (
          <Text as="p">
            Because the Venice protocol is built using smart contracts, it's
            ...
            <Link
              target="_blank"
              href="https://finkfi.netlify.app/protocol/security/#smart-contract-security-audits"
            >
      ...
      },
      {
        ...
        description: (
          <Text as="p">
            ...
            <Link
              target="_blank"
              href="https://finkfi.netlify.app/protocol/security/#collateral-asset-risks"
            >
              handful of risks
            </Link>{' '}
      ...
      },
      {
        ...
        description: (
          <Text as="p">
            ...
            <Link
              href="https://finkfi.netlify.app/protocol/security/#venice-protocol-risks"
              target="_blank"
            >
    ...
    <Card variant="inner">
      ...
      <Box variant="layout.verticalAlign" p={[3, 4]}>
        ...
        <Text ml="2" variant="legend">
          ...
          <Link
            href="https://finkfi.netlify.app/protocol/security/"
            target="_blank"
            sx={{ textDecoration: 'underline' }}
          >
            You can read more about risk in the Venice docs.
          </Link>
        </Text>
      </Box>
    </Card>
