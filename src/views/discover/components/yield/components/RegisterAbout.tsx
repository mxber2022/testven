    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-7">
      <div>
        <p className="mt-3 text-sm text-legend">
          <Trans>
            Welcome to Venice — a platform for creating, exploring, and
            ...
            created on Venice's Yield Protocol or Index Protocol
        ...
        <p className="mt-2 text-sm text-legend">
          <Trans>
            ...
            innovator with a wild idea, Venice makes it easy to launch your own
            asset-backed index.
          </Trans>
        </p>
        <p className="mt-2 text-sm text-legend">
      ...
      <div>
        <p className="mt-3 text-sm text-legend">
          <Trans>
            Yield DTFs (created on the Venice Yield Protocol) feature built-in
        ...
        <p className="mt-2 text-sm text-legend">
          <Trans>
            Still have questions? Come talk to us in the Venice Discord server.
            We'd be happy to help! You can also
          </Trans>{' '}
          <a className="underline" href={PROTOCOL_DOCS} target="_blank">
            explore the Venice Documentation for more details.
          </a>
        </p>
      </div>
    </div>
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-7">
    <div>
      <h3 className="text-xl font-semibold">
        <Trans>The Venice Project</Trans>
      </h3>
      <p className="mt-3 text-sm text-legend">
        <Trans>
          Venice aims to help people around the world maintain their spending
        ...
        <a className="underline" href="https://finkfi.netlify.app/" target="_blank">
          Learn more about Venice on their website.
        </a>
      </p>
      ...
      <p className="mt-2 text-sm text-legend">
        <Trans>
          ...
          Labs to interact with the Venice Protocol and various DTFs deployed
          with the protocol.
        </Trans>
      </p>
      <p className="mt-2 text-sm text-legend">
