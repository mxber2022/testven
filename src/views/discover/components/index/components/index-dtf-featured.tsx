...
const CAMPAIGN_URL = 'https://www.venicefi.com/dtflist'
...
const IndexDTFFeatured = () => {
  ...
  return (
    <div className="bg-secondary rounded-4xl p-1">
          ...
          return (
            ...
            >
              ...
              <Button
                ...
                onClick={(e) => {
                  e.preventDefault()
                  window.open(`https://www.venicefi.com/dtf/${dtf.chainId === ChainId.Mainnet ? 'ethereum' : 'base'}/detail/${dtf.address}`, '_blank')
                }}
                className="gap-1 mt-2 rounded-2xl w-full bg-[#FF6B35] hover:bg-[#FF6B35]/90 text-black"
              >
                <Coins size={16} />
      ...
      <div className="p-4 flex items-center gap-1 max-[1140px]:justify-center text-white">
